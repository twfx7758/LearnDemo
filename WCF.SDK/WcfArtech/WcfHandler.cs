...
namespace WCF.SDK
{
    public class WcfHandler : IHttpHandler
    {
        ...
        {
            //对HttpRequest进行解码生成请求消息对象
            Message request = this.MessageEncoderFactory.Encoder.ReadMessage(
                context.Request.InputStream, int.MaxValue, 
                "application/soap+xml; charset=utf-8");

            //通过请求消息得到代表服务的操作的Action
