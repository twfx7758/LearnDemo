...
namespace WebApi.Display
{
    ...
    public class MyHttpSelfHostServer : HttpServer
    {
        ...
        public void Open()
        {
            ...
            this.channellistener = binding.BuildChannelListener<IReplyChannel>(BaseAddress);
        ...
        public void Close()
        {
            if (this.channellistener != null && this.channellistener.State == System.ServiceModel.CommunicationState.Opened)
            {
